...
namespace SharpCompress.Archives.GZip
{
    public class GZipArchive : AbstractWritableArchive<GZipArchiveEntry, GZipVolume>
    {
        ...
        public static GZipArchive Open(string filePath, ReaderOptions readerOptions = null)
        {
            ...
            return Open(new FileInfo(filePath), readerOptions!=null ?readerOptions: new ReaderOptions());
        }
        ...
        public static GZipArchive Open(FileInfo fileInfo, ReaderOptions readerOptions = null)
        {
            ...
            return new GZipArchive(fileInfo, readerOptions!=null ?readerOptions: new ReaderOptions());
        }
        ...
        public static GZipArchive Open(Stream stream, ReaderOptions readerOptions = null)
        {
            ...
            return new GZipArchive(stream, readerOptions != null ? readerOptions : new ReaderOptions());
        }
