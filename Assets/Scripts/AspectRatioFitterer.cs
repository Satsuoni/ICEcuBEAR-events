...
{
    [AddComponentMenu("Layout/Aspect Ratio Fitterer", 143)]
    [ExecuteAlways]
    ...
    /// </summary>
    public class AspectRatioFitterer : UIBehaviour, ILayoutSelfController
    {
        /// <summary>
            ...
            switch (m_AspectMode)
            {
                ...
                case AspectMode.HeightControlsWidth:
                {
                    ...
                    rectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, rectTransform.rect.height * m_AspectRatio);
                        ...
                        float offsDrift =(rectTransform.offsetMin.x-rectTransform.offsetMax.x)/2.0f;
                        
                    rectTransform.offsetMax=new Vector2(-offsDrift,rectTransform.offsetMax.y);
                    rectTransform.offsetMin=new Vector2(offsDrift,rectTransform.offsetMin.y);
                    break;
                }
                case AspectMode.WidthControlsHeight:
                {
                    ...
                    rectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, rectTransform.rect.width / m_AspectRatio);
                        float offsDrift = (rectTransform.offsetMin.y - rectTransform.offsetMax.y) / 2.0f;
                        rectTransform.offsetMax=new Vector2(rectTransform.offsetMax.x,-offsDrift);
                    rectTransform.offsetMin=new Vector2(rectTransform.offsetMin.x,offsDrift);
                    break;
                }
